...
class AddToHomeScreen {
  ...
  _genIOSSafari(container: HTMLElement) {
    var containerInnerHTML =
      ...
      this._genListItem(
        ...
        `Tap the ${this._genListButtonWithImage(
          this._genAssetUrl("ios-safari-sharing-api-button-2.svg")
        )} button in the toolbar.`
      ) +
      this._genListItem(
        `2`,
        `Select ${this._genListButtonWithImage(
  ...
  _genIOSInAppBrowserOpenInSystemBrowser(container: HTMLElement) {
    var containerInnerHTML =
      ...
      this._genListItem(
        `1`,
        `Tap the ${`<img class="adhs-more-button" src="${this._genAssetUrl(
  ...
  _genAndroidChrome(container: HTMLElement) {
    var containerInnerHTML =
      ...
      this._genListItem(
        `1`,
        `Tap ${this._genListButtonWithImage(
  ...
  _genInstallAppHeader() {
    return (
      `<h1 class="adhs-install-app">` + "Install " + this.appName + `</h1>`
    );
  }
